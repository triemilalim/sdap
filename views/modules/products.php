  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <table class="table table-bordered table-striped dt-responsive table" width="100%">
                ...
                foreach ($products as $key => $value) {
                  echo '<tr>
                             ...
                             <td>'.$value["description"].'</td>';
                              ...
                              $categories = ControllerCategories::ctrShowCategories($item,$values);
                // var_dump($products);
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-12 col-sm-6">  
                ...
                <div class="input-group"> 
                  ...
                  <input type="number" class="form-control input-lg" id="newSellingPrice" name="newSellingPrice" step="any" maxlength="3" min="0" placeholder="Selling price" required>
