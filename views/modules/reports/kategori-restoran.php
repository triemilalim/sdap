...
$data = ControllerDashboard::ctrKategoriRestoran();

// $data["keterangan"] = str_replace("Jumlah","",$data["keterangan"]);
// var_dump($data);

$colours = array("red","green","yellow","aqua","purple","blue");

$total = ControllerDashboard::ctrTotalKategoriRestoran();
      	...
      	<div class="row">
	        ...
	        <div class="col-md-7">
	 			...
	 			<div class="chart-responsive">
	            	...
	            	<canvas id="pieChartKategoriRestoran" height="150"></canvas>
...
<script>
  ...
  var pieChartCanvas = $('#pieChartKategoriRestoran').get(0).getContext('2d');
