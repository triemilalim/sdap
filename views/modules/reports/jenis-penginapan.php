...
$data = ControllerDashboard::ctrAmbilDataJenisPenginapan();

// var_dump($data);

$colours = array("red","green","yellow","aqua","purple","blue","cyan","magenta","orange");

$total = ControllerDashboard::ctrTotal();
