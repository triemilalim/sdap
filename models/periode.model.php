...
// 		$value2 = $this->validateTahun;
	...
	/*=============================================
	SHOW PERIODE Tahunan
	=============================================*/

	static public function MdlShowPeriodeTahunan($tableUsers, $item, $value ,$item2 , $value2 , $tahun){


		$stmt = Connection::connect()->prepare("SELECT * FROM $tableUsers WHERE $item = :$item AND $item2 =:$item2 and tahun =$tahun");
